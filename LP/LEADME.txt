...
js/chart.js ------------ GoogleChart用のjavascriptファイル
js/script.js ------------------- このテンプレート用のjavascriptファイル
img/bg-top.jpg ----------------- サイトのメイン画像
img/image01.jpg ----------------- トップページのCorporate Mission画像
img/logo.jpg ----------------- サイトロゴ画像
img/logo-wt.png ----------------- サイトロゴ画像（白抜き）
img/process.jpg ----------------- 採用プロセスの画像
img/sample-day-img1.jpg ----------------- １日のスケジュール画像その1
img/sample-day-img2.jpg ----------------- １日のスケジュール画像その2
img/sample-img1.png ----------------- サンプルページのイメージ画像
img/sample-top-img.png ----------------- サンプルページのメイン画像
img/sec-img1.png ----------------- 募集職種のイメージ画像その1
img/sec-img2.png ----------------- 募集職種のイメージ画像その2
img/sec-img3.png ----------------- 募集職種のイメージ画像その3
img/staff-image1.jpg ----------------- スタッフ紹介の画像その1
img/staff-image2.jpg ----------------- スタッフ紹介の画像その2
img/staff-image3.jpg ----------------- スタッフ紹介の画像その3
css/script.css ------------------ このテンプレート用のstylesheetファイル
